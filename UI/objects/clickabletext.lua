...
local path = string.sub(..., 1, string.len(...) - string.len(".objects.clickabletext"))
local loveframes = require(path .. ".libraries.common")

-- clickabletext object
local newobject = loveframes.NewObject("clickabletext", "loveframes_object_clickabletext", true)
...
--	self.linkhovercolor = {0, 0, 255, 255}
	self.defaultcolor =		{150, 159, 142, 255}
	self.shadowcolor =		{0, 0, 0, 255}
	self.linkcolor =		{150, 159, 142, 255}
	self.linkhovercolor =	{216, 222, 211, 255}
	...
	if hover and linksenabled and not loveframes.resizeobject then
		...
		for k, v in ipairs(formattedtext) do
			...
			if link then
				...
				if col then
				--	v.hover = true
					for i, j in pairs(formattedtext) do
						j.hover = true
					end
					linkcol = true
				end
...
function newobject:draw()
	...
	local drawfunc = skin.DrawClickableText or skins[defaultskin].DrawText
...
--[[---------------------------------------------------------
	- func: DrawClickableText()
	- desc: draws the object's text
--]]---------------------------------------------------------
function newobject:DrawClickableText()
