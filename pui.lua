...
PUI.mainmenuFrame:SetSize( love.graphics.getWidth(), love.graphics.getHeight() + 25 )
...
PUI.newGame.Frame:SetSize( love.graphics.getWidth()/2, love.graphics.getHeight()/2 )
...
PUI.mainSettings.Frame:SetSize( love.graphics.getWidth()/2, love.graphics.getHeight()/2 )
...
PUI.settingsFrame:SetSize( love.graphics.getWidth()/2, love.graphics.getHeight()/2 )
